...
function widgets_init()
{
    register_nav_menus(array(
        'primary_nav' => __('Primary Nav', 'lc-hinoki2023'),
    ));
    // register_nav_menus(array(
    //     'top_nav' => __('Top Nav', 'lc-hinoki2023'),
    // ));

    register_nav_menus(array(
        'footer_menu1' => __('Footer Menu 1', 'lc-hinoki2023'),
    ));
    register_nav_menus(array(
        'footer_menu2' => __('Footer Menu 2', 'lc-hinoki2023'),
    ));
    // register_nav_menus(array(
    //     'footer_menu3' => __('Footer Menu 3', 'lc-hinoki2023'),
    // ));
    // register_nav_menus(array(
    //     'footer_menu4' => __('Footer Menu 4', 'lc-hinoki2023'),
    // ));
...
<div class="mx-4">
    <div class="testimonial">
        <a href="/testimonials/#<?=$slug?>">
            <div class="testimonial__content pb-3 <?=$text?>">
                <?=wp_trim_words(get_the_content(), 55)?>
            </div>
            <div class="testimonial__title pb-3 <?=$cite?>">
                <?=get_the_title()?>
            </div>
        </a>
    </div>
